    ...
    const cartValue =  (
            <Container id="orderSummary" className={classes.root} >
                ...
                <div className={classes.btn}  >
                    ...
                    <Button  variant="contained" color="secondary" onClick = {() => orderPlaced()} >
                          Place Order
                    </Button>
                </div>
        </Container>
    ...
    const cart = (
        <div id="SubmitOrdr" className="order-placed" >
            <Container className={classes.root} >
              <Typography variant="h1" className='order-placed' > Your Order has been successfully Placed :) </Typography>
            </Container>
        </div>
    )
